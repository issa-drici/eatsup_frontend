    ...
    return (
        <PageContainer>
            <div className="space-y-6">
                ...
                <Accordion type="single" collapsible defaultValue={!isMobile &&"actions"} className="mb-4">
                    <AccordionItem value="actions">
                        <AccordionTrigger
                            hideIcons={true}
                            className={cn(
                                "group flex items-center justify-between w-full px-6 py-4 rounded-xl bg-gradient-to-r from-orange-50 to-yellow-100 border border-orange-200 shadow hover:shadow-lg transition-all cursor-pointer text-lg font-bold text-orange-900 mb-2"
                            )}
                        >
                        ...
                        <AccordionContent className="pt-2 pb-4">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <Tooltip delayDuration={200}>
                                        <TooltipTrigger asChild>
                                            {hasCategories ? (
                                                    ...
                                                    <Card className="bg-gradient-to-r from-yellow-50 to-orange-50 border-yellow-200">
                                                        <CardContent className="p-6">
                                                            <div className="text-center space-y-3">
                                                                ...
                                                                <div>
                                                                    <h3 className="font-semibold text-gray-900">Générer avec l'IA</h3>
                                                                    <p className="text-sm text-gray-600">Importer une image ou un PDF</p>
                                                                </div>
                                                            </div>
                                                        </CardContent>
                                                    </Card>
                                                ...
                                                <Link href={`/admin/restaurant/${restaurantId}/menu/${menuId}/ai-menu-generator`}>
                                        ...
                                        {hasCategories && (
                                            <TooltipContent side="top" align="center">
                                                <span>
                                                    Pour utiliser à nouveau le générateur IA, supprimez toutes les catégories de votre menu.<br/>
                                                    <span className="text-xs text-muted-foreground">Vous pouvez ensuite importer une nouvelle image ou PDF pour régénérer votre menu.</span>
                                                </span>
                                            </TooltipContent>
                                        )}
                                    </Tooltip>
                                ...
                                {/* Paramètres du menu */}
                                <Link href={`/admin/restaurant/${restaurantId}/menu/${menuId}/update`}>
                                    <Card className="bg-gradient-to-r from-gray-50 to-gray-100 border-gray-200 hover:shadow-md transition-shadow cursor-pointer">
                                        <CardContent className="p-6">
                                            <div className="text-center space-y-3">
                                                ...
                                                <div>
                                                    <h3 className="font-semibold text-gray-900">Paramètres du menu</h3>
                                                    <p className="text-sm text-gray-600">Modifier le nom, les bannières, etc.</p>
                                                </div>
                                            </div>
                                        </CardContent>
                                    </Card>
