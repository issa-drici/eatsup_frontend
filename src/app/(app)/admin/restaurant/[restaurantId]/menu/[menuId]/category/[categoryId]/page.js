                            ...
                            <CardContent className="p-8">
                                <div className="text-center space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 mb-4">Ajoutez votre premier article dans cette catégorie</p>
                                        <Link href={`/admin/restaurant/${restaurantId}/menu/${menuId}/category/${categoryId}/item/create`}>
                                                ...
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end" className="w-48">
                                                        ...
                                                        <DropdownMenuItem
                                                            ...
                                                            disabled={item.sort_order === menuItems.length}
                                                        >
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-blue-800">
                                    Cliquez sur un article pour le modifier. Utilisez les flèches pour réorganiser l'ordre d'affichage.
                                </p>
                            </div>
                        </div>
                    </CardContent>
